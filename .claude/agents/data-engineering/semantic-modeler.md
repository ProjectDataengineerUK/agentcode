...
description: >-
  Semantic modeling and analytical consumption specialist. Use for: designing semantic models
  over Gold tables in Fabric Direct Lake, analyzing existing Fabric Semantic Models, generating
  DAX measures and business metrics, creating Databricks Metric Views, optimizing Gold tables
  for analytical consumption. Invoke when user mentions DAX, Semantic Model, Direct Lake,
  Genie Space, business metrics, or Power BI consumption.

  Use PROACTIVELY when designing semantic layers or DAX measures.
