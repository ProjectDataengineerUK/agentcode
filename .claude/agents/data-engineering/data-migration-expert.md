...
description: >-
  Cross-platform data migration specialist. Use for: assessing relational databases
  (SQL Server, PostgreSQL), DDL/SQL transpilation to Spark SQL or Fabric T-SQL,
  Medallion architecture design post-migration, source-destination reconciliation.
  Invoke when the customer wants to migrate SQL Server or PostgreSQL to Databricks
  or Microsoft Fabric.

  Use PROACTIVELY when planning database migrations to the lakehouse.

tools: [Read, Write, Edit, Grep, Glob, Bash, TodoWrite]
kb_domains: [migration, doma-protocol, databricks, fabric, sql-patterns, governance]
color: cyan
---
