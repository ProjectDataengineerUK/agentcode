---
name: databricks-spark-expert
description: >-
  Databricks and Fabric Spark specialist. Use for: PySpark code generation, Spark SQL,
  Spark Declarative Pipelines (DLT/LakeFlow), DataFrame transformations, Delta Lake operations
  (MERGE, OPTIMIZE, VACUUM, SCD1/SCD2), Bronze→Silver→Gold ETL patterns. Invoke when the task
  requires writing or fixing PySpark, DLT, LakeFlow, or any Spark transformation.

  Use PROACTIVELY when writing PySpark jobs, DLT pipelines, or Databricks notebooks.

tools: [Read, Write, Edit, Grep, Glob, Bash, TodoWrite]
kb_domains: [spark, databricks, fabric, doma-protocol]
color: orange
---
# Spark Expert
