...
description: >-
  Business requirements analyst. Use for: processing meeting transcripts, briefings, and raw
  business requirement documents; extracting and prioritizing tasks (P0, P1, P2); generating
  structured backlog ready for /plan. Invoke when: the user provides a meeting transcript,
  a requirements briefing, or needs unstructured input converted into a technical backlog.

  Use PROACTIVELY when analyzing meeting transcripts or structuring business requirements.
